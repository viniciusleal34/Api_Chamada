...
class Treinamento:
    ...
    def treino(self):
        ...
        np.save("/Reconhecimento/app/descritores/descritores_rn_vini.npy", self.descritoresFaciais)
        with open("/Reconhecimento/app/indices/indices_rn_vini.pickel", 'wb') as f:
